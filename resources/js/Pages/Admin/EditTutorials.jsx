...
export default function Tutorials({ auth, playlists, authorID, id_tutorial }, props) {
...
router.post(`/admin/tutorialUpdate/${id_tutorial.id}`, data)
}
return (
                ...
                <div>
                    <ul className="p-5 shadow rounded mt-2">
                        ...
                        <div className="mb-6">
                            ...
                            <select id="playlist"
                                className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                required value={author} onChange={(e)=> setAuthorID(e.target.value)}
                                >
                        ...
                        <a href='/admin/tutorials' className="btn btn-error">Back</a>
                    </ul>
                </div>
            </div>
        </div>
