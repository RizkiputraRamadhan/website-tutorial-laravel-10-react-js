...
router.post('/admin/playlistStore', data)
}
return (
                ...
                <tbody>
                    ...
                    <tr key={index + 1}>
                        ...
                        <th>
                            ...
                            <a href={`/admin/playlistEdit/${play.id}/${play.id_playlist}`}><button
                                    className="btn btn-ghost btn-xs"><i
                                        class="fa-solid fa-pen-to-square text-green-800"></i></button></a>
                            <a href={`/admin/playlistDelete/${play.id}/${play.id_playlist}`}><button
                                    className="btn btn-ghost btn-xs"><i
